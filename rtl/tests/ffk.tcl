...
set_property generic "EXP_IN_A=[lindex $argv 1] FRAC_IN_A=[lindex $argv 2] EXP_IN_B=[lindex $argv 3] FRAC_IN_B=[lindex $argv 4] ACC_DESIRED=[lindex $argv 5] ACC_EXTRA_BIT=[lindex $argv 6]" [current_fileset] 
