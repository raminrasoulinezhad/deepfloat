...
set myFiles [list paper_syn/PaperIntegerSystolicGrid.sv  paper_syn/PaperIntegerPETop.sv  paper_syn/PaperIntegerPE.sv];

# name of top level module
set basename PaperIntegerSystolicGrid;
