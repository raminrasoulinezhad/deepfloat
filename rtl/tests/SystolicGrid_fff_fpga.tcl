create_project project [lindex $argv 0] -part [lindex $argv 7]
...
add_files {../paper_syn/SystolicGrid_fff.sv}
add_files {../paper_syn/PE_fff.sv}
...
set_property top SystolicGrid_fff [current_fileset]
set_property generic "TILE=[lindex $argv 9] EXP_IN_A=[lindex $argv 1] FRAC_IN_A=[lindex $argv 2] EXP_IN_B=[lindex $argv 3] FRAC_IN_B=[lindex $argv 4] EXP_OUT=[lindex $argv 5] FRAC_OUT=[lindex $argv 6] TRAILING_BITS=1" [current_fileset] 
